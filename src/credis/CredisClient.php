...
/**
 * CredisClient (a fork of Redisent)
 *
 ...
 * @package CredisClient
 */

if( ! defined('CRLF')) define('CRLF', sprintf('%s%s', chr(13), chr(10)));

/**
 * CredisClient, a lightweight Redis PHP standalone client and phpredis wrapper
 *
 * Server/Connection:
 * @method CredisClient pipeline()
 * @method CredisClient multi()
 * @method array         exec()
...
class CredisClient {
    ...
    public function forceStandalone()
    {
        ...
        if($this->connected) {
            throw new CredisException('Cannot force CredisClient to use standalone PHP driver after a connection has already been established.');
        }
     ...
     * @param $callback
     * @return $this|array|bool|CredisClient|mixed|null|string
     * @throws CredisException
     */
