...
use Exception;
use queues\resque\ResqueWorker;
use queues\resque\failure\ResqueFailureRedis;
...
class ResqueFailure
{
     ...
     * @param \ResqueWorker $worker Instance of ResqueWorker that was running this job when it failed.
    ...
    public static function getBackend()
    {
        if(self::$backend === null) {
            // self::$backend = 'ResqueFailureRedis';
            self::setBackend('ResqueFailureRedis');
        }
